...
public class WebBarangKosongHandler extends WebServletHandler {

	public WebBarangKosongHandler(final HttpServletRequest request, final HttpServletResponse response) throws Throwable {
	...
	public String process() {
		...
		try {
			...
			return "/WEB-INF/jsp/barangKosong.jsp";
	}
