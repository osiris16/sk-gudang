...
public class WebBerandaSalesHandler extends WebServletHandler {

	public WebBerandaSalesHandler(final HttpServletRequest request, final HttpServletResponse response) throws Throwable {
	...
	public String process() {
		...
		try {
			...
			if(!_type.equalsIgnoreCase("ADMIN")){
				return "/WEB-INF/jsp/berandaSales.jsp";
			}
