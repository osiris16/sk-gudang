...
public class WebCatatanAuditHandler extends WebServletHandler {

	public WebCatatanAuditHandler(final HttpServletRequest request, final HttpServletResponse response) throws Throwable {
	...
	public String process() {
		...
		return "/WEB-INF/jsp/catatanaudit.jsp";
	}
