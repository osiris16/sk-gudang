...
public class WebHistoryHandler extends WebServletHandler {

	public WebHistoryHandler(final HttpServletRequest request, final HttpServletResponse response) throws Throwable {
	...
	public String process() {
		...
		return "/WEB-INF/jsp/history.jsp";
	}
