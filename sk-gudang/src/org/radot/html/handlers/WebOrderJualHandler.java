...
public class WebOrderJualHandler extends WebServletHandler {

	public WebOrderJualHandler(final HttpServletRequest request, final HttpServletResponse response) throws Throwable {
	...
	public String process() {
		...
		return "/WEB-INF/jsp/orderjual.jsp";
	}
