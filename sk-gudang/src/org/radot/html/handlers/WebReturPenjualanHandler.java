...
public class WebReturPenjualanHandler extends WebServletHandler {

	public WebReturPenjualanHandler(final HttpServletRequest request, final HttpServletResponse response) throws Throwable {
	...
	public String process() {
		...
		return "/WEB-INF/jsp/returpenjualan.jsp";
	}
