...
public class WebSalesmanHandler extends WebServletHandler {

	public WebSalesmanHandler(final HttpServletRequest request, final HttpServletResponse response) throws Throwable {
	...
	public String process() {
		...
		return "/WEB-INF/jsp/salesman.jsp";
	}
