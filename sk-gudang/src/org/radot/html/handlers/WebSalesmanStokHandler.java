...
public class WebSalesmanStokHandler extends WebServletHandler {

	public WebSalesmanStokHandler(final HttpServletRequest request, final HttpServletResponse response) throws Throwable {
	...
	public String process() {
		...
		return "/WEB-INF/jsp/salesmanstok.jsp";
	}
