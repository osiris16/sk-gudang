...
public class WebSystemUserHandler extends WebServletHandler {

	public WebSystemUserHandler(final HttpServletRequest request, final HttpServletResponse response) throws Throwable {
	...
	public String process() {
		...
		return "/WEB-INF/jsp/systemuser.jsp";
	}
